...
//  new added  features
	  ...
	  public static final int SEALEDCLASSDEF = SCOPY + 1; 
	  public static final int GUARDEDSTMT = SEALEDCLASSDEF + 1;
	  public static final int IFSUBSTMT = GUARDEDSTMT + 1;
	  public static final int VARSTMT = IFSUBSTMT + 1;
	  public static final int CONST_ARRAY = VARSTMT + 1;
	  public static final int INITARRAY = CONST_ARRAY + 1;
	  public static final int DOUBLEPLUS = INITARRAY + 1;
	  public static final int GETSUBARRAY = DOUBLEPLUS + 1;
	  public static final int DEFAULT = GETSUBARRAY + 1;
	  public static final int IN = DEFAULT + 1;
	  public static final int FOREACHSTMT = IN + 1;
	  public static final int NORMALSTMT = FOREACHSTMT + 1;
	  public static final int TYPEVAR = NORMALSTMT + 1;
    /**
    ...
    public static class GuardedStmt extends Tree {
        ...
        public GuardedStmt(List<Tree> slist, Location loc) {
    ...
    public static class IfSubStmt extends Tree {
        ...
        public IfSubStmt(Expr condition, Tree stmt, Location loc) {
            super(IFSUBSTMT, loc);
    ...
    public static class Scopy extends Tree {
    	...
    	public String className;
       	...
       	public Scopy(String className, Expr expr, Location loc) {
            super(SCOPY, loc);
       		this.className = className;
       		this.expr = expr;
       		this.ident = new Ident(null,className,loc);
          }
    ...
    public static class ForeachStmt extends Tree {
        ...
        public ForeachStmt(LValue lvalue,Expr expr1, Expr expr2, Tree stmt, Location loc) {
            super(FOREACHSTMT, loc);
    		this.expr1 = expr1;
    		this.expr2 = expr2;
    		// if(this.expr2 == null) {
    			// System.out.println("you are null hahaha");
    		// }
    		this.lvalue = lvalue;
    		this.stmt = stmt;
    		this.block = new Block(null,loc);
        }
    ...
    public static class VarStmt extends LValue {
        ...
        public VarStmt(String ident, Location loc) {
            super(VARSTMT, loc);
    		this.ident = ident;
        }
    	...
    	@Override
    	public void printTo(IndentPrintWriter pw) {
    		pw.println("var "+ident);
    	}
    }
    
    public static class NormalStmt extends LValue {
    	public String ident;
    	public TypeLiteral literaltype;
    	public Variable symbol;

        public NormalStmt(String ident, TypeLiteral type, Location loc) {
            super(NORMALSTMT, loc);
    		this.ident = ident;
...
//    		System.out.println(type.type);
    	...
    	@Override
        public void accept(Visitor v) {
            v.visitNormalStmt(this);
        }

    	@Override
    	public void printTo(IndentPrintWriter pw) {
    		if(type == null) {
    			pw.println(ident +" var");
    		}
    		else {
	    		pw.print(ident + " ");
	    		literaltype.printTo(pw);
	    		pw.println("");
    		}
    	}
    }
    ...
    public static class Const_Array extends Expr {

    	public List<Expr> elist;

        public Const_Array(List<Expr> elist,Location loc) {
            super(CONST_ARRAY, loc);
        	this.elist = elist;
        }

    	@Override
        public void accept(Visitor v) {
            v.visitConst_Array(this);
        }
	...
	public static class DoublePlus extends Expr {
	    	
	    	public Expr left;
	    	public Expr right;
	    	
	    	 public DoublePlus(Expr left,Expr right,Location loc) {
	             super(DOUBLEPLUS, loc);
	             this.left = left;
	             this.right = right;
	         }
	 ...
	 public static class InitArray extends Expr {
	    	...
	    	public Variable symbol;
	    	 ...
	    	 public InitArray(Expr left,Expr right,Location loc) {
	             super(INITARRAY, loc);
	             this.left = left;
	             this.right = right;
	         }
	 ...
	 public static class GetSubArray extends Expr {
	    	
	    	public Expr arrayname;
	    	public Expr left;
	    	public Expr right;
	    	
	    	 public GetSubArray(Expr arrayname,Expr left,Expr right,Location loc) {
	             super(GETSUBARRAY, loc);
	             this.left = left;
	             this.right = right;
	 ...
	 public static class Default extends Expr {
	 	...
	 	public Expr right;
	 	 ...
	 	 public Default(Expr arrayname,Expr left,Expr right,Location loc) {
	          super(DEFAULT, loc);
	          this.left = left;
	          this.right = right;
	          this.arrayname = arrayname;
	 ...
	 public static class In extends Expr {
		 	...
		 	public String ident;
		 	 ...
		 	 public In(Expr arrayname,String ident,Expr left,Expr right,Location loc) {
		          super(DEFAULT, loc);
		          this.left = left;
		          this.right = right;
		          this.ident = ident;
    ...
    public static class Typevar extends TypeLiteral {
    	
	 	
        public Typevar( Location loc) {
            super(TYPEVAR, loc);
        }
    ...
    public static abstract class Visitor {
        ...
        public void visitSealedClassDef(SealedClassDef that) {
            visitTree(that);
        }
        ...
        public void visitConst_Array(Const_Array that) {
            visitTree(that);
        }
        public void visitInitArray(InitArray that) {
        	visitTree(that);
        }
        public void visitDoublePlus(DoublePlus that) {
        	visitTree(that);
        }
        public void visitGetSubArray(GetSubArray that) {
        	visitTree(that);
        }
        public void visitDefault(Default that) {
        	visitTree(that);
        }
        public void visitIn(In that) {
        	visitTree(that);
        }
        public void visitForeachStmt(ForeachStmt that) {
        	visitTree(that);
        }
        public void visitNormalStmt(NormalStmt that) {
        	visitTree(that);
        }
