...
public class Tac {
	...
	private String binanyOpToString(String op) {
		if(op0 == null) System.out.println("here1");
		if(op1 == null) System.out.println("here2");
		if(op2 == null) System.out.println("here3");
	...
	public String toString() {
		...
		case MARK:
			return label.name + ":";
		case PARM:
//			System.out.println("ghjghjgjh");
//			System.out.println(op0.id);
