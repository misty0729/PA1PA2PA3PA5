...
public final class RuntimeError {
	...
	public static final String NEGATIVE_ARR_INIT_SIZE = "Decaf runtime error: The length of the created array should not be less than 0.\n";
	
	public static final String DIVIDED_BY_ZERO = "Decaf runtime error: Division by zero error.\n";
}
