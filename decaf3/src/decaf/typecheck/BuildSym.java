...
//			System.out.println(cd.parent);
			if(cd instanceof Tree.SealedClassDef) {
				Class c = cd.symbol;
				for (Tree.ClassDef sealed : program.classes) {
//					System.out.println(c.getType());
					if(sealed.symbol.getParent()!=null) {
//						System.out.println(sealed.symbol.getParent().getType());
						if(c.getType().equal(sealed.symbol.getParent().getType())) {
							issueError(new BadSealedInherError(sealed.getLocation()));
						}
					}
				}
			}
...
////			if(!((Tree.NormalStmt)foreach.lvalue).literaltype.type.compatible(((ArrayType)foreach.expr1.type).getElementType())) {
...
//		}
	...
	@Override
	public void visitNormalStmt(Tree.NormalStmt normalstmt) {
		if(normalstmt.literaltype == null) { // var
//			System.out.println("HERE");
			normalstmt.literaltype = new Tree.Typevar(normalstmt.getLocation());
			normalstmt.literaltype.type = BaseType.UNKNOWN;
//			System.out.println("HERE");
//			System.out.println(normalstmt.literaltype);
		}
		else {
//			System.out.println("HERE1");
			normalstmt.literaltype.accept(this);
//			System.out.println(normalstmt.literaltype.type);	
		}
//		else {
//			normalstmt.type
//		}
//		if(normalstmt.type == null)
